...
const CATEGORIES = [{
    ...
    text: "LP-SWIM – Lernen und Perfektionieren. In seinem Berufsalltag in den Viernheimer Bädern erlebte Gründer Lukas Prehn aus erster Hand, wo die Hürden des klassischen Schwimmunterrichts liegen. Auch wenn Gruppenkurse wunderbar für das soziale Miteinander sind, bleiben in starren Formaten unweigerlich manche Teilnehmer auf der Strecke, weil schlicht die Zeit für individuelle Betreuung fehlt. Zudem gibt es für Erwachsene kaum Angebote, da reguläre Kurse oft mangels Teilnehmern gar nicht erst zustande kommen. Genau aus dieser Lücke heraus entstand LP-SWIM. Wer den echten Willen zum Lernen mitbringt, findet bei uns den sicheren Weg ins Wasser – mit ungeteilter Aufmerksamkeit und verbandsgeprüft durch den <a href='https://schwimmlehrerverband.de/dslv-gepruefte-schwimmschulen' target='_blank' rel='noopener noreferrer'>DSLV</a>."
  }, {
